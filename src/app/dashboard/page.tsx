...
export default async function DashboardPage() {
  ...
  const stats = statsResult.ok ? {
    totalXp: statsResult.totalXp,
    globalLevel: statsResult.globalLevel,
    practiceSessionsCompleted: statsResult.practiceSessionsCompleted,
    topicsStarted: statsResult.topicsStarted,
  } : null;
